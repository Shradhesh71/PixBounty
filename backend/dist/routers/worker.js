...
router.get("/nextTask", middleware_1.workerMiddleware, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!task) {
        res.status(411).json({
            message: "No more task are left foe reviewed.",
        });
    }
    else {
